(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactTabsManager"] = factory(require("react"));
	else
		root["ReactTabsManager"] = factory(root["React"]);
  ...
  _createClass(TabItem, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          props = _objectWithoutProperties(_props, ['index', 'onClick', 'className']);

      var ctx = this.context.tabs;

      return _react2.default.createElement('a', _extends({}, props, {
        className: (0, _classnames2.default)(className, _defineProperty({}, ctx.activeClassName, ctx.view === this.props.index)),
        role: 'button',
        href: '#',
        onClick: this.switch }));
    }
